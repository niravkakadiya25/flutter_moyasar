...
class PaymentProvider extends ChangeNotifier {
  ...
  void setPaymentGatewayData(MoyasarPaymentData moyasarPaymentData) {
    ...
    paymentUrlRequest = URLRequest(
      url: Uri.parse(
        "${MoyasarPaymentControllers.moyasarPaymentUrl}?purchaseAmount=${moyasarPaymentData.purchaseAmount}&appName=${moyasarPaymentData.description}&pSk=$publishableSecretKey&locale=${moyasarPaymentData.locale.index}&paymentOptions=$paymentOptions&description=${moyasarPaymentData.description}",
      ),
    );
